...
export default function validate<T extends object>(type: "body"|"query"|"params", targetClass: ClassConstructor<T>) {
    return async (req: Request, _res: Response, next: NextFunction) => {
        const instance = plainToInstance(targetClass, req[type]);
